...
export interface ILiquidityFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addLiquidity"
      | "collectFees"
...
export interface ILiquidityFacet extends BaseContract {
  connect(runner?: ContractRunner | null): ILiquidityFacet;
  waitForDeployment(): Promise<this>;

  interface: ILiquidityFacetInterface;
