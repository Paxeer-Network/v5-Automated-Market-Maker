...
export interface FlashLoanFacetInterface extends Interface {
  getFunction(
    nameOrSignature: "flashLoan" | "getFlashLoanFee" | "setFlashLoanFee"
  ): FunctionFragment;
...
export interface FlashLoanFacet extends BaseContract {
  connect(runner?: ContractRunner | null): FlashLoanFacet;
  waitForDeployment(): Promise<this>;

  interface: FlashLoanFacetInterface;
